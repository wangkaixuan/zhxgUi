...
```javascript
import Vue from 'vue';
import ElementUI from 'element-zhxg-ui';
import 'element-zhxg-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-zhxg-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import Element from 'element-zhxg-ui';
...
```js
import Vue from 'vue';
import { Button } from 'element-zhxg-ui';
